...
const OuPage = () => (
  <Layout title="localisation atelier">
   ...
   <Item  txts={['Venant de Rue Gaston Barrate / Boulevard Montalembert']} img='ou/ou_from_gaston_baratte.webp'/>
   <Item  txts={['Venant de Rue Kléber']} img='ou/ou_from_kleber.webp'/>
   <Item  txts={['Dans cette servitude, la 3eme maison sur votre droite']} img='ou/ou_garage.webp'/>
   <Item  txts={['Vous ne pouvez pas louper la pancarte sur la porte !']} img='ou/ou_pancarte.webp'/>
   <p className='text-xs text-zinc-500'>(sauf si j’ai l’ai laissé ouverte ... )</p>
   <Item title='Accéder'/>
   <Item title='Vélo'  txts={['Vous pouvez laisser votre vélo sur la terasse devant l’atelier, vous pourez ainsi surveiller qu’il ne fugue pas', 'Si vous avez peur qu’il attrape froid avec la pluie nous le mettrons au Garage avec le mien ']} img='ou/ou_interieur.webp'/>
   
   <p className='text-xs text-zinc-500'>(merci de ne ramener que des vélos bien dressés pour ne pas embêter les voisins)</p>
   <Item title='Train' txts={['La Gare d’ascq  est à 350m à pied de l’atelier et à 15 minutes de Lille Flandre']} img='ou/ou_train.webp'/>
   <Item title='Bus' txts={['Vous pouvez prendre les lignes 13 - 73 - 910 La 73 et 910 passent par le metro Pont-de-bois', 'Horaires']}/>
    ...
    <Item txts={['La place est reservée aux particpants de l’atelier Si une personne est deja arrivée des places sont disponibles :', 'Rue Masséna']} img='ou/ou_parking_1.webp'/>
    <Item txts={['Rue des Martyrs']} img='ou/ou_parking_2.webp'/>
   </div>
